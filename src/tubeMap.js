...
export default function tubeMap() {
  ...
  function map(selection) {
    selection.each(function(data) {
      ...
      xGeoScale
        .domain([
          d3.min(data.stations.toArray(), function(station) {
      ...
      var geoStations = gEnter
        .append('g')
        .attr('class', 'geoStations')
        .style('display', 'none')
        .selectAll('path')
        .data(function(d) {
          return d.stations.toArray();
      ...
      var discrepencies = gEnter
        .append('g')
        .attr('class', 'discrepencies')
        .style('display', 'none')
        .selectAll('path')
        .data(function(d) {
          return d.stations.toArray();
        ...
        .attr('d', function(d) {
          ...
          return lineFunction([
            ...
            [
              d.x +
                d.shiftX * lineWidthMultiplier +
                lineWidthMultiplier * dir[0],
              d.y +
                d.shiftY * lineWidthMultiplier +
                lineWidthMultiplier * dir[1],
            ],
          ]);
        })
        .attr('stroke', function(d) {
      ...
      geoStations
        ...
        .attr('transform', function(d) {
          return (
            'translate(' +
            xGeoScale(d.position !== undefined ? d.position.lon : NaN) +
            ',' +
            yGeoScale(d.position !== undefined ? d.position.lat : NaN) +
            ')'
          );
        })
        .attr('id', function(d) {
